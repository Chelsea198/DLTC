...
import com.example.DanhLam.Control.Interfaces.DangBinhLuanInterface;
...
public class BinhLuanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String vitridanhlam=getIntent().getStringExtra("vitridanhlam");

        AddControl();
        txtDiaChiDanhLam=findViewById(R.id.txtDiaChiDanhLam);
        txtTenDL=findViewById(R.id.txtTenDL);

        txtDiaChiDanhLam.setText(vitridanhlam);
    ...
    public void setStar(int index)
    {
        ...
        {
            listStar.get(i).setImageDrawable(getResources().getDrawable(R.drawable.star_2));

        }
        for(int i=index;i<5;i++)
        {
            listStar.get(i).setImageDrawable(getResources().getDrawable(R.drawable.star_1));
        }
    }
}
